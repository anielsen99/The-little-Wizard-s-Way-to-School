export class InstructionsScene extends Phaser.Scene {
    ...
    create() {
      ...
      // Zauberer-Grafik als Deko
      this.add.sprite(leftX - 160, centerY - 135, 'wizard', 0).setScale(0.8);
  
      this.createKeyBadge(leftX - 60, centerY - 150, 'A / D');
      this.add.text(leftX + 20, centerY - 150, 'oder ◄ / ► : Bewegen', {
        fontSize: '14px',
        fontFamily: 'monospace',
        color: '#ffffff'
      }).setOrigin(0, 0.5);
  
      this.createKeyBadge(leftX - 60, centerY - 115, 'W');
      this.add.text(leftX + 20, centerY - 115, 'oder ▲ : Springen', {
        fontSize: '14px',
        fontFamily: 'monospace',
        color: '#ffffff'
      }).setOrigin(0, 0.5);
